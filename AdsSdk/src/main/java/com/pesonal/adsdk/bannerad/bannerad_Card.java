...
public class bannerad_Card extends CardView {

    public bannerad_Card(@NonNull Context context) {
        super(context);
    ...
    public bannerad_Card(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        View view = LayoutInflater.from(context).inflate(R.layout.ad_text, this, false);
        addView(view);
    ...
    public bannerad_Card(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
