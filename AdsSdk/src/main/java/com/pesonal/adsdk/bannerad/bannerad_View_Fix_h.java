...
public class bannerad_View_Fix_h extends FrameLayout {

    public bannerad_View_Fix_h(@NonNull Context context) {
        super(context);
    ...
    public bannerad_View_Fix_h(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        View view = LayoutInflater.from(context).inflate(R.layout.ad_text, this, false);
        addView(view);
    ...
    public bannerad_View_Fix_h(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
