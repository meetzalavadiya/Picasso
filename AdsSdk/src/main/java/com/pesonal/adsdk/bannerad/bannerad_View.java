...
public class bannerad_View extends FrameLayout {

    public bannerad_View(@NonNull Context context) {
        super(context);
        ...
        AppManage.getInstance((Activity) context).banner(this, new banner_listner() {
            ...
            public void on_admob_loded(NativeAd ad, ViewGroup containor) {
                new view_Ad_sdk(context).inflate_NATIV_BANNER_ADMOB(ad, containor,false);
            }

            @Override
            public void on_facebook_loded(NativeBannerAd ad, ViewGroup containor) {
                new view_Ad_sdk(context).inflate_NB_FB(ad, containor,false);
            }

            @Override
            public void on_startapp_loded(ArrayList<NativeAdDetails> ad, ViewGroup containor) {
                new view_Ad_sdk(context).inflate_NB_STARTAPP(ad, containor,false);
            }
        });
    }

    public bannerad_View(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        View view = LayoutInflater.from(context).inflate(R.layout.ad_text, this, false);
        addView(view);
    ...
    public bannerad_View(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
