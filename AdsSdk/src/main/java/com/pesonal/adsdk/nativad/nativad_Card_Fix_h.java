...
public class nativad_Card_Fix_h extends CardView {

    public nativad_Card_Fix_h(@NonNull Context context) {
        super(context);
        ...
        AppManage.getInstance((Activity) context).nativeAd(this, new nativ_listner() {
            ...
            public void on_admob_loded(NativeAd ad, ViewGroup containor) {
                new view_Ad_sdk(context).inflate_NATIV_ADMOB(ad, containor,true);
            }

            @Override
            public void on_facebook_loded(com.facebook.ads.NativeAd ad, ViewGroup containor) {
                new view_Ad_sdk(context).inflate_NATIV_FB(ad, containor,true);
            }

            @Override
            public void on_startapp_loded(ArrayList<NativeAdDetails> ad, ViewGroup containor) {
                new view_Ad_sdk(context).inflate_NATIV_STARTAPP(ad, containor,true);
            }
        });
    }

    public nativad_Card_Fix_h(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        View view = LayoutInflater.from(context).inflate(R.layout.ad_text, this, false);
        addView(view);
        AppManage.getInstance((Activity) context).nativeAd(this, new nativ_listner() {
    ...
    public nativad_Card_Fix_h(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
