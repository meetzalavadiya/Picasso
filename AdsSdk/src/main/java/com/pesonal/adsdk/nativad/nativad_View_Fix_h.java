...
public class nativad_View_Fix_h extends FrameLayout {
    ...
    public nativad_View_Fix_h(@NonNull Context context) {
        super(context);
    ...
    public nativad_View_Fix_h(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        View view = LayoutInflater.from(context).inflate(R.layout.ad_text, this, false);
        addView(view);
        AppManage.getInstance((Activity) context).nativeAd(this, new nativ_listner() {
    ...
    public nativad_View_Fix_h(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
