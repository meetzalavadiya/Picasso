...
public class nativad_Card extends CardView {

    public nativad_Card(@NonNull Context context) {
        super(context);
    ...
    public nativad_Card(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        View view = LayoutInflater.from(context).inflate(R.layout.ad_text, this, false);
        addView(view);
        AppManage.getInstance((Activity) context).nativeAd(this, new nativ_listner() {
    ...
    public nativad_Card(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
